...
class LuohanyaCaptureThread(QThread):    
    # 开始抓图
    ...
    def __init__(self,positionList):
        ...
        #全局变量
        self.savePath = "detectDir/luohanya/capImg/" # where are these images that were cptured to store
        self.positionList = positionList
        self.num = 0
        self.save_path = "./detectDir/luohanya/detect/" # 
        self.curImgSavePath = "detectDir/luohanya/capImg/"
    ...
    def startWork(self):
        ...
        if capImgRes != None:
            ...
            photo.save("detectDir/luohanya/capImg/lhy.jpg")
            self.num += 1
            #发送展示抓取图像信号
            self.getImageSig.emit("detectDir/luohanya/capImg/lhy.jpg")
        else:
            print("luohanya图片抓取失败")
    ...
    def capImgRequest(self):
        ...
        #组成json
        postData = dict(cameraIndexCode="003795")
