...
class YantaiWindow(QWidget):
    def __init__(self):
        super().__init__() # 初始化
        with open("muping.log", 'a+', encoding='utf8') as logFile:
        ...
        self.positionList = []
        self.backgroundRole()
        self.savePath = "detectDir\\yantai\\capImg\\"
        #云台扫描范围
    ...
    def setRangeOfCamera(self):
        print("烟台-牟平-扫面范围:")
        '''********************** zoom ：25 ***********************'''
        for i in range(2528,3601,126):
            for n in range(2971,3223,63):
                tmpStr = str(i) + '-' + str(n) + '-' + "25"
                self.positionList.append(tmpStr)
        for i in range(1,1522,126):
            for n in range(2971,3223,63):
                tmpStr = str(i) + '-' + str(n) + '-' + "25"
                self.positionList.append(tmpStr)    
        '''********************** zoom ：30 ***********************'''   
        for i in range(2528,3601,86):
            for n in range(3266,3352,43):
                tmpStr = str(i) + '-' + str(n) + '-' + "30"
                self.positionList.append(tmpStr)
        for i in range(1,1522,86):
            for n in range(3266,3352,43):
                tmpStr = str(i) + '-' + str(n) + '-' + "30"
                self.positionList.append(tmpStr) 
        '''********************** zoom ：50 ***********************'''   
        for i in range(2489,3601,57):
            tmpStr = str(i) + '-' + '3380' + '-' + "50"
            self.positionList.append(tmpStr)
        for i in range(1,1522,57):
            tmpStr = str(i) + '-' + '3380' + '-' + "50"
            self.positionList.append(tmpStr)
        '''********************** zoom ：65 ***********************'''   
        for i in range(2478,3601,41):
            for n in range(3400,3461,20):
                tmpStr = str(i) + '-' + str(n) + '-' + "65"
                self.positionList.append(tmpStr)
        for i in range(1,1522,86):
            for n in range(3400,3461,20):
                tmpStr = str(i) + '-' + str(n) + '-' + "65"
                self.positionList.append(tmpStr) 
        '''********************** zoom ：90 ***********************'''   
        for i in range(2448,3601,31):
            tmpStr = str(i) + '-' + '3475' + '-' + "90"
            self.positionList.append(tmpStr)
        for i in range(1,1522,31):
            tmpStr = str(i) + '-' + '3475' + '-' + "90"
        '''********************** zoom ：120 ***********************'''   
        for i in range(2448,3601,23):
            tmpStr = str(i) + '-' + '3485' + '-' + "120"
            self.positionList.append(tmpStr)
        for i in range(1,1522,23):
            tmpStr = str(i) + '-' + '3485' + '-' + "120"
        '''********************** zoom ：140 ***********************'''   
        for i in range(2448,3601,20):
            tmpStr = str(i) + '-' + '3495' + '-' + "140"
            self.positionList.append(tmpStr)
        for i in range(1,1556,20):
            tmpStr = str(i) + '-' + '3495' + '-' + "140"
        '''********************** zoom ：150 ***********************'''   
        for i in range(2443,3601,20):
            tmpStr = str(i) + '-' + '3505' + '-' + "150"
            self.positionList.append(tmpStr)
        for i in range(1,1556,20):
            tmpStr = str(i) + '-' + '3505' + '-' + "150"
            self.positionList.append(tmpStr)
        '''********************** zoom ：180 ***********************'''   
        for i in range(2440,3601,15):
            for n in range(3512,3520,7):
                tmpStr = str(i) + '-' + str(n) + '-' + "180"
                self.positionList.append(tmpStr)
        for i in range(1,1556,15):
            for n in range(3512,3520,7):
                tmpStr = str(i) + '-' + str(n) + '-' + "180"
                self.positionList.append(tmpStr)
        '''********************** zoom ：190 ***********************'''   
        for i in range(2440,3601,13):
            for n in range(3525,3532,6):
                tmpStr = str(i) + '-' + str(n) + '-' + "190"
                self.positionList.append(tmpStr)
        for i in range(1,1556,13):
            for n in range(3525,3532,6):
                tmpStr = str(i) + '-' + str(n) + '-' + "190"
                self.positionList.append(tmpStr)
        '''********************** zoom ：200 ***********************'''   
        for i in range(2526,3601,13):
            tmpStr = str(i) + '-' + '3537' + '-' + "200"
            self.positionList.append(tmpStr)
        for i in range(1,1556,13):
            tmpStr = str(i) + '-' + '3537' + '-' + "200"
            self.positionList.append(tmpStr)
        for i in range(2573,3601,13):
            tmpStr = str(i) + '-' + '3543' + '-' + "200"
            self.positionList.append(tmpStr)
        for i in range(1,1556,13):
            tmpStr = str(i) + '-' + '3543' + '-' + "200"
            self.positionList.append(tmpStr)
        for i in range(2636,3601,13):
            tmpStr = str(i) + '-' + '3549' + '-' + "200"
            self.positionList.append(tmpStr)
        for i in range(1,1490,13):
            tmpStr = str(i) + '-' + '3549' + '-' + "200"
            self.positionList.append(tmpStr)
        '''********************** zoom ：270 ***********************'''   
        for i in range(2662,3601,9):
            tmpStr = str(i) + '-' + '3553' + '-' + "270"
            self.positionList.append(tmpStr)
        for i in range(1,1436,9):
            tmpStr = str(i) + '-' + '3553' + '-' + "270"
            self.positionList.append(tmpStr) 
        for i in range(2811,3601,9):
            tmpStr = str(i) + '-' + '3557' + '-' + "270"
            self.positionList.append(tmpStr)
        for i in range(1,1370,9):
            tmpStr = str(i) + '-' + '3557' + '-' + "270"
            self.positionList.append(tmpStr)
        for i in range(2811,3601,9):
            tmpStr = str(i) + '-' + '3561' + '-' + "270"
            self.positionList.append(tmpStr)
        for i in range(1,1284,9):
            tmpStr = str(i) + '-' + '3561' + '-' + "270"
            self.positionList.append(tmpStr)
        '''********************** zoom ：410 ***********************'''   
        for i in range(2779,3601,9):
            tmpStr = str(i) + '-' + '3565' + '-' + "410"
            self.positionList.append(tmpStr)
        for i in range(1,1190,9):
            tmpStr = str(i) + '-' + '3565' + '-' + "410"
            self.positionList.append(tmpStr) 
        for i in range(2806,3601,9):
            tmpStr = str(i) + '-' + '3569' + '-' + "410"
            self.positionList.append(tmpStr)
        for i in range(1,1138,9):
            tmpStr = str(i) + '-' + '3569' + '-' + "410"
            self.positionList.append(tmpStr) 
        for i in range(2857,3601,9):
            tmpStr = str(i) + '-' + '3573' + '-' + "410"
            self.positionList.append(tmpStr)
        for i in range(1,1040,9):
            tmpStr = str(i) + '-' + '3573' + '-' + "410"
            self.positionList.append(tmpStr) 
        for i in range(2875,3601,9):
            tmpStr = str(i) + '-' + '3577' + '-' + "410"
            self.positionList.append(tmpStr)
        for i in range(1,969,9):
            tmpStr = str(i) + '-' + '3577' + '-' + "410"
            self.positionList.append(tmpStr) 
        for i in range(2926,3601,9):
            tmpStr = str(i) + '-' + '3581' + '-' + "410"
            self.positionList.append(tmpStr)
        for i in range(1,912,9):
            tmpStr = str(i) + '-' + '3581' + '-' + "410"
            self.positionList.append(tmpStr)
        for i in range(2968,3601,9):
            tmpStr = str(i) + '-' + '3585' + '-' + "410"
            self.positionList.append(tmpStr)
        for i in range(1,859,9):
            tmpStr = str(i) + '-' + '3585' + '-' + "410"
            self.positionList.append(tmpStr)
        for i in range(2988,3601,9):
            tmpStr = str(i) + '-' + '3589' + '-' + "410"
            self.positionList.append(tmpStr)
        for i in range(1,791,9):
            tmpStr = str(i) + '-' + '3589' + '-' + "410"
            self.positionList.append(tmpStr)
    ...
    def startBtnSlot(self):
        ...
        # 开始截图
        self.captrueImgThread = YantaiCaptureThread(self.positionList)
        ...
        # 检测
        self.predictThread = YantaiPredictThread()
        # 开始检测
    ...
    def startUploadSlot(self,predictResSavePath):
        # 上传
        self.uploadThread = YantaiUploadThread(predictResSavePath)
        # 开始上传
    ...
    def openHistDir(self):
        ...
        openFolderStr = "start explorer " + current_path + "\\detectDir\\yantai\\detect\\"
        os.system(openFolderStr)
    ...
    def recept(self):
        ...
        # 开始截图
        self.receptImgThread = YantaiCaptureThread(positionList)
        # 展示抓取到的图片
    ...
    def saveCapImg(self, imgdata, imgNamStr):
        ...
        self.mkdir("capture\\yantai")
        savePath = "capture\\yantai\\"
